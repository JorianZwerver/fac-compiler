...
/**
 * Class for generation stage of the compiler. Converts the assembly in a set of instructions
 * which can be converted in either Intel Hex, binary, or a markdown file.
 * @extends AbstractParseTreeVisitor<string>
 * @implements facVisitor<string>
 */
export class Generation extends AbstractParseTreeVisitor<string> implements facVisitor<string> {
	...
	// Stores labels and their location
	labelTable!: 	Map<string, number>;
	// Stores the values of definations
	defineTable!: 	Map<string, string>;
	// Stores the generated instructions
	instructions!: Instructions[];
	// Counter for the amount of instructions
	instructionCounter!: number;
	// Map to map each register name to a binary code
	...
	/**
	 * Generates an instruction set from a .fac file.
	 * @param content the document as string to be converted to instructions
	 * @param table table containing the labels and there corresponding location in the code (is generated by elaborator)
	 * @returns the resulting set of instructions
	 */
	...
	/**
	 * Adds instruction to program and increments counter.
	...
	visitLw(ctx: LwContext): string {
		this.addInstruction(
			new Instructions(
				InstructionType.I,
				"0000",
				Number(super.visit(ctx.input(1))),
